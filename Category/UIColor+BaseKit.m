...
@implementation UIColor (BaseKit_UIColor_Hex)
...
+ (UIColor *)bk_colorWithHexString:(NSString *)color {
    return [[self class] bk_colorWithHexString:color alpha:1.f];
}
...
+ (UIColor *)bk_colorWith8BitRed:(NSInteger)red green:(NSInteger)green blue:(NSInteger)blue {
    return [[self class] bk_colorWith8BitRed:red green:green blue:blue alpha:1.f];
}
